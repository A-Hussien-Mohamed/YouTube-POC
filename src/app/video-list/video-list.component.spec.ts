...
describe('VideoListComponent', () => {
  ...
  it("should subscribe on currentVideoList object  to get videos once updated", () => {
  ...
  it("should subscribe on currentPredicate object to be update with the latest predicate", () => {
    const fixture = TestBed.createComponent(VideoListComponent);
    const dataService = fixture.debugElement.injector.get(DataService);
    fixture.detectChanges();
    let videoList: response;
    ...
    dataService.search(predicate);
    dataService.setSearchPridicate(predicate);
    let resultPredicate: searchPridicate;
    dataService.currentPredicate.subscribe(result => { resultPredicate = result; });
    expect(resultPredicate).toBe(predicate);
  });
